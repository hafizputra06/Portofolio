      ...
      <button
        ...
        className={cn(
          "inline-flex items-center justify-center rounded-xl font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500/50 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95",
          {
            ...
            "bg-slate-800 text-white hover:bg-slate-700 active:bg-slate-600 shadow-lg shadow-slate-900/30 hover:shadow-xl dark:bg-slate-800 dark:text-white dark:hover:bg-slate-700 dark:active:bg-slate-600 dark:shadow-slate-900/50 dark:border dark:border-slate-600":
              variant === "dark",
          },
          {
